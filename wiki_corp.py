    ...
    * <LANG>wiki-latest-pages-articles.xml.bz2
    ...
    def __init__(self, fname, processes=None, lemmatize=utils.has_pattern(), dictionary=None,
        ...
        if dictionary is None:
            self.dictionary = Dictionary(self.get_texts(), 10000000)
        else:
...
models = [
    # PV-DBOW 
    Doc2Vec(dm=0, dbow_words=1, size=500, window=20, min_count=20, iter=10, workers=cores, callbacks=[EpochLoggerDBOW("DBOW")]),
    # PV-DM w/average
    Doc2Vec(dm=1, dm_mean=1, size=500, window=20, min_count=20, iter=10, workers=cores, callbacks=[EpochLoggerDM("DM")]),
]
