...
models = [
    # PV-DBOW 
    Doc2Vec(dm=0, dbow_words=1, size=1000, window=20, min_count=20, iter=10, workers=cores, callbacks=[EpochLoggerDBOW("DBOW")]),
    # PV-DM w/average
    Doc2Vec(dm=1, dm_mean=1, size=1000, window=20, min_count=20, iter=10, workers=cores, callbacks=[EpochLoggerDM("DM")]),
]
